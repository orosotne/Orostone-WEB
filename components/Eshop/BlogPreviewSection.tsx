  ...
  return (
    <section className="blog-section relative z-[1] -mt-px py-12 lg:py-16 bg-[#FAFAFA]">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div
          ref={scrollRef}
          className="blog-scroll-container flex gap-4 overflow-x-auto overscroll-x-contain snap-x snap-mandatory pb-2 -mx-4 px-4 scroll-pl-4 lg:-mx-0 lg:px-0 lg:scroll-pl-0"
