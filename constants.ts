...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p><strong>Ľadovo čistá biela</strong> so subtílnou kryštalickou textúrou. Pripomína zasneženú krajinu a prináša do interiéru pocit <strong>svežosti a čistoty</strong>.</p>',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p><strong>Teplá biela</strong> s jemnými béžovými podtónmi a delikátnymi žilkami. Elegantná a útulná zároveň — <strong>harmónia pre každý interiér</strong>.</p>',
    category: 'sintered-stone',
    sku: 'YW-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p>Nadčasový <strong>travertínový vzor</strong> s teplými béžovými a krémovými tónmi. Mediteránsky šarm <strong>bez náročnej údržby</strong> prírodného kameňa.</p>',
    category: 'sintered-stone',
    sku: 'RT-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p>Exotický <strong>zlatisto-béžový kameň</strong> s jemnými žilkami inšpirovaný legendárnym indickým mramorom. <strong>Absolútny luxus</strong> s orientálnym šarmom.</p>',
    category: 'sintered-stone',
    sku: 'TM-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p><strong>Krémovo biela</strong> s jemnými šedými žilkami pripomínajúcimi ranné oblaky. <strong>Jemnosť a elegancia</strong> v každom detaile.</p>',
    category: 'sintered-stone',
    sku: 'VW-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p>Klasický statuario s výrazným sivým žilovaním na bielom podklade. <strong>Ikona luxusu</strong> v sinterovanom kameni — <strong>verná replika talianskeho originálu</strong>.</p>',
    category: 'sintered-stone',
    sku: 'PS-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p>Luxusný biely kameň so <strong>zlatistým žilovaním</strong>, ktorý evokuje najvzácnejšie talianske mramory. <strong>Symbol elegancie a opulencie</strong>.</p>',
    category: 'sintered-stone',
    sku: 'GG-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p>Tmavý industriálny kameň s <strong>medenými a hrdzavými odleskami</strong>. <strong>Surová krása kovu</strong> pretavená do sinterovaného kameňa.</p>',
    category: 'sintered-stone',
    sku: 'IC-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p>Dramatická <strong>hlboká čierna so zlatými žilkami</strong>. <strong>Majestátny kameň</strong> inšpirovaný gotickou architektúrou a šperkami.</p>',
    category: 'sintered-stone',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p>Vzdušný biely kameň s jemným <strong>oblačným vzorovaním</strong> v sivých a béžových tónoch. <strong>Calacatta inšpirácia</strong> s mäkkším, poetickejším vyjadrením.</p>',
    category: 'sintered-stone',
    sku: 'NC-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p>Prémiová verzia <strong>legendárneho Carrara mramoru</strong>. Biely podklad s charakteristickými sivými žilkami — <strong>nadčasová klasika</strong> v modernom prevedení.</p>',
    category: 'sintered-stone',
    sku: 'CP-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
  ...
  // ============================================================
  {
    ...
    descriptionHtml: '<p><strong>Vrchol elegancie</strong>. Čistá biela s výraznými sivými žilkami v dokonalej harmónii — <strong>náš najluxusnejší kameň</strong> pre tých, ktorí akceptujú len to najlepšie.</p>',
    category: 'sintered-stone',
    sku: 'BS-3200-1600-12',
    vendor: 'OROSTONE',
    productType: 'Sinterovaný kameň',
