...
<p>Voľba hrúbky je pri ostrovčeku kritickejšia ako pri bežnej doske:</p>

<ul>
  <li><strong>20 mm (odporúčaná pre ostrovčeky):</strong> pevnosť v ohybe 16 000 N, bezpečný previs do 350 mm bez podpery, masívny vzhľad</li>
  <li><strong>12 mm:</strong> ľahšia, lacnejšia, ale previs max 150 mm bez podpery. Vhodná len ak je celá doska podopretá korpusom. Ideálna pre <a href="/blog/neviditelna-varna-doska-v-sinterovanom-kamene">neviditeľné varné dosky</a> v zóne varenia.</li>
</ul>

<p>Ak plánujete barové sedenie s previsom, <strong>20 mm je jediná bezpečná voľba</strong>. Pri 12 mm a previse nad 200 mm hrozí prasknutie pod bodovým zaťažením (napríklad oprenie sa o hranu).</p>
...
<ul>
  <li><strong>Half bullnose (polkruhová):</strong> najbezpečnejšia voľba — zaoblená hrana minimalizuje riziko chipingu aj pri náraze. Ideálna pre rodiny s deťmi.</li>
...
<ul>
  ...
  <li><strong>Nerezové konzoly pre previsy</strong> — pri barových previsoch nad 250 mm sú konzoly povinné. Montujú sa pod dosku, skryté za obkladovým panelom.</li>
  <li><strong>Podlepenie MDF doskou</strong> — pod celou plochou kamennéj dosky pre rovnomerný tlak a elimináciu bodového zaťaženia</li>
</ul>
...
<ol>
  ...
  <li><strong>Montáž</strong> — osadenie na silikón, lepenie waterfall sekcií, napojenie drezu a varičá (3–5 hodín)</li>
...
`,
    faqs: [
      ...
      },
      {
        ...
        answer: 'Áno. Ostrovček potrebuje kuchynský korpus ako jadro, podlepenie MDF doskou pre rovnomerný tlak a nerezové konzoly pri barových previsoch nad 250 mm. Konzoly sa montujú pod dosku a sú skryté za obkladom.',
      },
      {
  ...
  en: {
    ...
    directAnswer: 'A sintered stone kitchen island requires a 20 mm slab for overhangs above 300 mm, stainless steel support brackets, and precise CNC cutouts. For the waterfall effect, slabs are joined at a 45° angle with color-matched adhesive. Typical price for a complete island: €2,500–6,000 including fabrication and installation.',
    content: '<p>Article available in Slovak. <a href="/blog/kuchynsky-ostrovcek-zo-sinterovaneho-kamena">Čítať po slovensky</a></p>',
    faqs: [
      { question: 'What thickness of sintered stone is needed for a kitchen island?', answer: 'For islands with overhangs (bar seating), 20 mm is mandatory — it has 3× the bending strength of 12 mm.' },
      { question: 'How much does a sintered stone kitchen island cost?', answer: 'A medium island (2,000 × 900 mm) with two waterfall edges costs €2,500–4,000 including material, fabrication, delivery and installation.' },
