...
const ARTICLES_META: BlogArticleMeta[] = [
  ...
  },
  {
    ...
    en: {
      title: 'Sintered Stone vs Quartz vs Ceramic vs Dekton: What\'s the Real Difference?',
      subtitle: 'Technical comparison of materials for premium kitchen countertops — without marketing clichés',
      excerpt: 'Comprehensive comparison of sintered stone, quartz, porcelain slabs and Dekton. Real numbers, certifications, price ranges and a decision tree for your project.',
    },
  },
  {
