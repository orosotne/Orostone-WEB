...
export const appRoutes = (
  <>
    ...
    {/* Categories */}
    <Route path="/kategoria/:slug" element={<Suspense fallback={<CategoryPageSkeleton />}><CategoryPage /></Suspense>} />
    <Route path="/kategoria/:slug/:subCategory" element={<Suspense fallback={<CategoryPageSkeleton />}><CategoryPage /></Suspense>} />

    {/* Product Detail */}
    <Route path="/produkt/:id" element={<Suspense fallback={<ProductDetailSkeleton />}><ShopProductDetail /></Suspense>} />

    {/* Checkout Flow */}
    <Route path="/checkout" element={<Suspense fallback={<CheckoutSkeleton />}><Checkout /></Suspense>} />
    <Route path="/objednavka-dokoncena" element={<Suspense fallback={<LoadingSpinner text="Načítavam..." fullScreen={false} />}><ThankYou /></Suspense>} />

    {/* Auth — /login, /register, /ucet and /objednavky are handled by server redirects in vercel.json (→ Shopify Customer Accounts) */}

    {/* Blog */}
    <Route path="/blog" element={<Suspense fallback={minH}><BlogPage /></Suspense>} />
    <Route path="/blog/:slug" element={<Suspense fallback={minH}><BlogArticlePage /></Suspense>} />

    {/* Info Pages */}
    <Route path="/doprava" element={<Suspense fallback={minH}><DopravaAPlatba /></Suspense>} />
    <Route path="/reklamacie" element={<Suspense fallback={minH}><ReklamacieAVratenie /></Suspense>} />
    <Route path="/odstupenie-od-zmluvy" element={<Suspense fallback={minH}><OdstupeniOdZmluvy /></Suspense>} />
    <Route path="/kontakt" element={<Suspense fallback={minH}><EshopContact /></Suspense>} />
    <Route path="/vzorky" element={<Suspense fallback={minH}><Vzorky /></Suspense>} />
    <Route path="/sinterovany-kamen" element={<Suspense fallback={minH}><SinterovanyKamen /></Suspense>} />
    <Route path="/vyhody" element={<Suspense fallback={minH}><Vyhody /></Suspense>} />
